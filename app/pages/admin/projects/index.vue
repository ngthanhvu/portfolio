        ...
        <tbody class="divide-y divide-border">
          ...
          >
            <td class="px-4 py-3 text-center">
              <input :checked="selected.has(project.id)" type="checkbox" class="h-4 w-4 rounded border-border" @change="toggleRow(project.id)">
            </td>
            ...
            <td class="px-4 py-3 text-left">
              ...
              >
                <span class="max-w-[280px] truncate">{{ project.url }}</span>
